...
{   
   //if ( $err == '') // no error
  {
   ...
   /* fwrite ($fileHandle,cname."|"." ".industry."|"." ".location."|"." ".datepicker."|"." ".comdes."|"." ".comweb."|"." ".phone."|"." ".raddress."|"." ".fullname."|"." ".mobile."|"." ".email."|"." ".cpan."|"." ".cgst."|"." ". PHP_EOL);
    $cname= fwrite ($fileHandle,$cname."|"." "); 
    $industry= fwrite ($fileHandle,$industry."|"." "); 
    $location= fwrite ($fileHandle,$location."|"." ");
    $datepicker= fwrite ($fileHandle,$datepicker."|"." ");
    $comdes= fwrite ($fileHandle,$comdes."|"." ");
    $comweb= fwrite ($fileHandle,$comweb."|"." ");   
    $phone= fwrite ($fileHandle,$phone."|"." ");   
    $raddress= fwrite ($fileHandle,$raddress."|"." "); 
    $fullname= fwrite ($fileHandle,$fullname."|"." "); 
    $mobile= fwrite ($fileHandle,$mobile."|"." "); 
    $email= fwrite ($fileHandle,$email."|"." "); 
    $cpan= fwrite ($fileHandle,$cpan."|"." "); 
    $cgst = fwrite ($fileHandle,$cgst. PHP_EOL. PHP_EOL); 
    fclose($fileHandle); */
    

     $con=mysqli_connect("region","username","password","dbname","3306"); 
 
    /*    $sql="INSERT INTO employerprofile (cname,industry,location,datepicker,comdes,comweb,phone,raddress,fullname,mobile,email,cpan,cgst) VALUES ('".$_POST["cname"]."','".$_POST["industry"]."','".$_POST["location"]."','".$_POST["datepicker"]."','".$_POST["comdes"]."','".$_POST["comweb"]."','".$_POST["phone"]."','".$_POST["raddress"]."','".$_POST["fullname"]."','".$_POST["mobile"]."','".$_POST["email"]."','".$_POST["cpan"]."','".$_POST["cgst"]."')";*/
        ...
        $sq = mysqli_query($con,"SELECT ID from employerprofile where email='$var'");
        $sq1=mysqli_fetch_assoc($sq);
        $sq3=$sq1['ID'];
        //echo $sq1." ".$var;
...
<html>
  ...
  <body onload="disableSubmit()" style="background-color:#D3D3D3" >
      ...
      <h4 align="center"> Employer Profile </h4> <?php //echo 'hello'; ?>
       ...
       ?>
        ...
        <select id="tst" name="industry"  required >
        <?php        
       ...
       ?> 
        ...
        <td><input type="url" name="comweb" placeholder="Company website"  required/></td></tr>
        ...
        <tr><td>Email:<label class="required">*</label> </td>
        ...
        <td><input type="text" name="cgst" class="gstinnumber" required/></td></tr>
      </tr>      
